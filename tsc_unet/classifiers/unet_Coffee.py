...
class Classifier_UNET:
    ...
    def __init__(self, output_directory, input_pre1, input_pre2, input_pre3, input_pre4, nb_classes, verbose=True,
                 build=True):  # verbose false
        self.output_directory = output_directory
        if build == True:
            self.model = self.build_model(input_pre1, input_pre2, input_pre3, input_pre4, nb_classes)
            if (verbose == True):
                self.model.summary()
    ...
    def drow(self,history,output_directory):
        ...
        plt.show()
    def fit(self, x_train, x_trainn1, x_trainn2, x_trainn3, y_train, x_testn1, x_testn2, x_testn3, y_val,
