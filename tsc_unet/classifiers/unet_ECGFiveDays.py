...
class Classifier_UNET:
    ...
    def fitt(self, x_train, x_trainn1, x_trainn2, x_trainn3, x_trainn4, y_train, x_testn1, x_testn2, x_testn3, x_testn4,
            y_val,
