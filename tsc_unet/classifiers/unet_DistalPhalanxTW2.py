...
class Classifier_UNET:
    ...
    def build_model(self, input_pre1, input_pre2, input_pre3, input_pre4, input_pre5, nb_classes):
        ...
        conv1 = Conv2D(a, 2, padding='same',kernel_regularizer=regularizers.l2(e))(output_combine)  # 需要的是拼接后的特征
        print('conv1', conv1.shape)
        conv1 = keras.layers.BatchNormalization()(conv1)
        conv1 = keras.layers.Activation('relu')(conv1)
        conv1 = Conv2D(a, 2, padding='same', kernel_regularizer=regularizers.l2(e))(conv1)
        print('conv1', conv1.shape)
        conv1 = keras.layers.BatchNormalization()(conv1)
        conv1 = keras.layers.Activation('relu')(conv1)
        ...
        conv2 = Conv2D(2 * a, 2, padding='same', kernel_regularizer=regularizers.l2(e))(conv2)
        conv2 = keras.layers.BatchNormalization()(conv2)
        conv2 = keras.layers.Activation('relu')(conv2)
        ...
        conv3 = Conv2D(4 * a, 2, padding='same', kernel_regularizer=regularizers.l2(e))(conv3)
        conv3 = keras.layers.BatchNormalization()(conv3)
        conv3 = keras.layers.Activation('relu')(conv3)
        ...
        # 4，两个3x3卷积，2x2最大池化
        conv4 = Conv2D(8 * a, 2, activation='relu', padding='same',kernel_regularizer=regularizers.l2(e))(pool3)
        ...
        conv5 = Conv2D(16 * a, 2, padding='same',kernel_regularizer=regularizers.l2(e))(pool4)
        ...
        conv6 = Conv2D(8 * a, 2, padding='same',kernel_regularizer=regularizers.l2(e))(drop5)  # (            )#2, 2, 512
        ...
        conv6 = Conv2D(8 * a, 2, padding='same', kernel_regularizer=regularizers.l2(e))(conv6)
        conv6 = keras.layers.BatchNormalization()(conv6)
        conv6 = keras.layers.Activation('relu')(conv6)
        print('conv6', conv6.shape)

        conv7 = Conv2D(4 * a, 2, padding='same',kernel_regularizer=regularizers.l2(e))(conv6)  # ()
        conv7 = keras.layers.BatchNormalization()(conv7)
        conv7 = keras.layers.Activation('relu')(conv7)
        up7 = UpSampling2D(size=(2, 2))(conv7)
        merge7 = concatenate([conv3, up7], axis=3)
        conv7 = Conv2D(4 * a, 2, padding='same', kernel_regularizer=regularizers.l2(0.001))(merge7)
        conv7 = keras.layers.BatchNormalization()(conv7)
        conv7 = keras.layers.Activation('relu')(conv7)
        ...
        conv8 = Conv2D(2 * a, 2, padding='same',kernel_regularizer=regularizers.l2(e))(conv7)
        ...
        conv9 = Conv2D(a, 2, padding='same',kernel_regularizer=regularizers.l2(e))(conv8)
        ...
        gap_layer = keras.layers.GlobalAveragePooling2D()(output_block_2)  # 出错
        print('gap', gap_layer.shape)
        output_layer = keras.layers.Dense(nb_classes, activation='softmax', name='output1')(gap_layer)
        print('out', output_layer.shape)
    ...
    def fit(self, x_train, x_trainn1, x_trainn2, x_trainn3, x_trainn4, y_train, x_testn1, x_testn2, x_testn3, x_testn4,
            y_val,
